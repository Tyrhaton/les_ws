...
// IWYU pragma: private, include "my_interfaces/msg/hardware_status.hpp"
...
{
public:
  explicit Init_HardwareStatus_temperature(::my_interfaces::msg::HardwareStatus & msg)
  : msg_(msg)
  {}
...
public:
  ...
  {}
  Init_HardwareStatus_temperature version(::my_interfaces::msg::HardwareStatus::_version_type arg)
  {
...
{
  return my_interfaces::msg::builder::Init_HardwareStatus_version();
}
