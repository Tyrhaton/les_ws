...
public:
    ...
    {
        publisher_theanswer_ = this->create_publisher<my_interfaces::msg::HardwareStatus>("the_answer", 10);
    ...
    void timer_theanswer_function()
    {
        ...
        publisher_theanswer_->publish(msg);
...
private:
    rclcpp::Publisher<my_interfaces::msg::HardwareStatus>::SharedPtr publisher_theanswer_;
